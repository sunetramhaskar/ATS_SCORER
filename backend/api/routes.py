...
async def analyze_resume(
    ...
    try:
        from backend.database.supabase import save_analysis
...
async def get_history(user_id: str = Depends(get_current_user)):
    ...
    from backend.database.supabase import get_user_history
    try:
...
async def delete_history_entry(
    ...
    from backend.database.supabase import delete_analysis
    try:
